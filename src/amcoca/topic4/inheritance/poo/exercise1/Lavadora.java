...
public class Lavadora extends Electrodomestico {
	...
	public Lavadora(String nombre, int alturaCM, int anchoCM, int profundidadCM, double pesoKG, String color,
			double capacidadTotalEnKG, double precioEnBolivianos, int nroRevolucionesPorMinuto, String velocidadMinima,
