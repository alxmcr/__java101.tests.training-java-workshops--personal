...
public class Refrigerador extends Electrodomestico {
	private String tipoLuzInterior; // led, incandescente
	private String sistemaDeEnfriamiento;

	public Refrigerador(String nombre, int alturaCM, int anchoCM, int profundidadCM, double pesoKG,
			String color, double capacidadTotalEnKG, double precioEnBolivianos,
			String tipoLuzInterior, String sistemaDeEnfriamiento) {
